...
This project is indexed by GitNexus as **lingbi** (8287 symbols, 18983 relationships, 468 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
Issues 托管在 GitHub (xiaohai-uid/lingbi)，通过 `gh` CLI 操作。See `docs/agents/issue-tracker.md`.
